...
component{
	// Layout Variables
    this.name       	= "ContentBox cbMEtronic Theme";
	this.description 	= "ContentBox cbMEtronic layout for ContentBox 3 based on Bootstrap 3";
    this.version        = "1.0";
	this.author 		= "Lucid Solutions";
	...
	// Layout Settings
	this.settings = [
		{ name="cbBootswatchTheme", 	group="Colors", defaultValue="red", 	type="select", 		label="ContentBox Color Palette:", 	required="false", optionsUDF="getSwatches", groupIntro="Control the color scheme of your entire site by changing the color palette.", fieldHelp="#loadHelpFile( 'cbBootswatchTheme.html' )#"  },
			...
			{ name="locAddress", 			group="Location", defaultValue="Your Address Location", 		type="text", 	label="Address:"},
			{ name="locCity", 				group="Location", defaultValue="City", 							type="text", 	label="City:"},
			{ name="locState", 				group="Location", defaultValue="State", 						type="text", 	label="State:"},
			{ name="locZip", 				group="Location", defaultValue="Zip", 							type="text", 	label="Zip:"},
			{ name="locPhone", 				group="Location", defaultValue="+91-9632587410", 				type="text", 	label="Phone:"},
			{ name="locEmail", 				group="Location", defaultValue="demo@email.com", 				type="text", 	label="Email:"},
			
			{ name="aboutcontent", 			group="About", defaultValue="", 		type="textarea", 	label="About us:", groupIntro="About Us in footer section of your theme.", 	fieldDescription="Enter the content for About us."  },
			...
			{ name="socialD", 		group="Social", defaultValue="", 		type="text", 	label="Dribble:" },
			{ name="socialLD", 		group="Social", defaultValue="", 		type="text", 	label="Linkedin:" },
	...
	*/
	array function getSwatches(){
		return listToArray( "red,blue,green,orange,gray,turquoise" );
	}
